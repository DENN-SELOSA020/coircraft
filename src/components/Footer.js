  ...
  return (
    <footer style={{ background: "#0E2011", color: "#fff", fontFamily: "var(--font-body)" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "56px 24px 40px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "40px 32px", marginBottom: 44, paddingBottom: 44, borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
          <div>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {['📘', '📸', '🐦'].map((icon, i) => (
                <div key={i} style={{ width: 34, height: 34, background: "rgba(255,255,255,0.06)", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 15, cursor: "pointer", border: "1px solid rgba(168,255,62,0.1)", transition: "all 0.2s" }}
        ...
        <div style={{ textAlign: "center" }}>
          <p style={{ fontSize: 12, color: "rgba(255,255,255,0.28)", marginBottom: 6 }}>
            © 2026 CoirCraft PH — Innobytes | All Rights Reserved
          </p>
    ...
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {links.map(({ href, label }) => (
          <Link key={label} href={href} style={{ color: "rgba(255,255,255,0.45)", fontSize: 13, textDecoration: "none", transition: "color 0.2s" }}
